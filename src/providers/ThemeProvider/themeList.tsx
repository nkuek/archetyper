...
const prefersDarkMmq = window.matchMedia('(prefers-color-scheme: dark)');

let prefersDark = prefersDarkMmq.matches;

prefersDarkMmq.addEventListener('change', (e) => {});
...
const themeList: IThemeList = {
  ...
  default: {
    buttonBackground: prefersDark ? 'black' : 'white',
    pageBackground: prefersDark ? 'black' : 'white',
    wordBoxBackground: prefersDark ? '#333' : 'white',
    currentWord: 'plum',
    currentChar: 'darkmagenta',
    words: prefersDark ? 'white' : 'black',
    correct: 'green',
    headings: prefersDark ? 'white' : 'black',
    border: `1px solid ${prefersDark ? 'white' : 'black'}`,
    disabled: '#ddd',
    lineColor2: 'darkmagenta',
    legendBackground: prefersDark ? 'black' : 'white',
  },
};
